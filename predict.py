...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "C:\yaogan\yolov7-tiny-pytorch-master\yolov7-tiny-pytorch-master\VOCdevkit\VOC2007\JPEGImages"
    dir_save_path   = "C:\yaogan\yolov7-tiny-pytorch-master\yolov7-tiny-pytorch-master\VOCdevkit/img_out"
    #-------------------------------------------------------------------------#
