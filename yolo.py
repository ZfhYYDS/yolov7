...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'C:\yaogan\yolov7-tiny-pytorch-master\yolov7-tiny-pytorch-master\logs/best_epoch_weights.pth',
        "classes_path"      : 'C:\yaogan\yolov7-tiny-pytorch-master\yolov7-tiny-pytorch-master\VOCdevkit\VOC2007/classes.txt',
        #---------------------------------------------------------------------#
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        for i, c in list(enumerate(top_label)):
            ...
            label_size = draw.textbbox((0, 0), label, font)[2:]
...
class YOLO_ONNX(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "onnx_path"         : 'C:\yaogan\yolov7-tiny-pytorch-master\yolov7-tiny-pytorch-master\logs/best_epoch_weights.pth',
        "classes_path"      : 'C:\yaogan\yolov7-tiny-pytorch-master\yolov7-tiny-pytorch-master\VOCdevkit\VOC2007/classes.txt',
        #---------------------------------------------------------------------#
        #   anchors_path代表先验框对应的txt文件，一般不修改。
        #   anchors_mask用于帮助代码找到对应的先验框，一般不修改。
